<!-- filepath: /Users/henriquemateus/Projetos/finance-frontend/pages/incomes/create.vue -->
<template>
    <div class="create-container">
      ...
      <div v-if="showSuccessModal" class="modal-overlay">
        <div class="modal">
          <h2>Sucesso</h2>
          <p>Receita registrada com sucesso!</p>
  ...
  const submitIncome = async () => {
    ...
    try {
      await axios.post('http://localhost:3333/api/incomes', income.value, {
        headers: {
      ...
      errorMessage.value = 'Erro ao registrar receita'
